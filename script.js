...
/* MIDLERTIDIG TEST – kun disse tre slideshow-filer vises */
var SLIDESHOW_TEST_FILER = [
  "mos2.jpg",
  "mos3.jpg",
  "3dprint.gif"
];
    ...
    .then(function(files) {
      ...
      var nyeFiler = files
        .filter(function(file) {
          return (
            file.type === "file" &&
            slideshowFiltype(file.name) &&
            SLIDESHOW_TEST_FILER.indexOf(file.name) !== -1
          );
        })
        .map(function(file) {
          return {
...
function skjulSlideshowMedier() {
  ...
  if (mobilImg) mobilImg.style.display = "none";
...
function visSlideshowBillede() {
  ...
  if (mobilImg) {
    mobilImg.src = fil.url;
    mobilImg.style.display = "block";
  }
