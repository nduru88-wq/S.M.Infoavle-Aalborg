...
function varighedTilMinutter(varighed) {
  ...
  /*
    NYE aktiviteter gemmes som decimaltimer:
    0.25 = 15 min
    0.50 = 30 min
    0.75 = 45 min
    1.75 = 1 t 45 min

    Disse værdier kontrolleres FØRST, så 0.75 aldrig kan blive
    opfattet som 75 minutter.
  */
  ...
  /*
    Bagudkompatibilitet med ældre timer.minutter-værdier,
    fx 0.15 = 15 min, 0.30 = 30 min, 0.45 = 45 min.
  */
