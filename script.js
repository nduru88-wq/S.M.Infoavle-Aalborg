...
if (erFoedselsdag) {
  ...
  "<div class='event-main-content'>" +
    (tid
      ? "<div class='event-time' style='font-size:12px; line-height:1.05; color:#555; font-weight:bold; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; margin-bottom:2px;'>" + tid + "</div>"
      : "") +
