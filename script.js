...
if (erFoedselsdag) {
 ...
 "<div class='event-actions'>" +
  "<button class='delete-btn' onclick=\"event.stopPropagation(); sletAktivitetFraTavle('" + id + "', '" + escapeHtml(formatDatoInput(visningsDato || lavDatoFraInput(a.dato))) + "', '" + escapeHtml(String(a.gentagelse || "ingen")) + "', '" + escapeHtml(String(a.parentId || "")) + "')\">Slet</button>" +
...
function kaldSletApi(action, params, fejltekst) {
...
function visGentagSletDialog(id, dato) {
  lukGentagSletDialog();
...
function sletAktivitetFraTavle(id, dato, gentagelse, parentId) {
  if (!id) {
