...
function visSlideshowBillede() {
  ...
  /* Første billede vises med det samme. */
  if (!img.getAttribute("src")) {
    img.src = nytBillede;
    img.classList.add("slideshow-synlig");
    return;
  }

  /* Ton det gamle billede roligt ud. */
  img.classList.remove("slideshow-synlig");

  setTimeout(function() {
    /* Forudindlæs næste billede, så overgangen ikke blinker. */
