...
/***** ANJA ANNIVERSARY - BOUNCE OVERLAY *****/
...
function startAnjaAnniversaryBounce() {
  ...
  var x = 24;
  var y = 24;
  var vx = 95;  // pixels pr. sekund vandret
  var vy = 72;  // pixels pr. sekund lodret
  var sidsteTid = null;
  ...
  function tegn(tid) {
    if (sidsteTid === null) sidsteTid = tid;

    // Undgå store spring hvis fanen/skærmen har været sat på pause.
